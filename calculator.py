...
L = Label(GUI,text='โปรแกรมหารกัน',font=('Angsana New',30,'bold'),fg='#f542b0')
L.pack(pady=20)

###############E1###################
L = Label(GUI,text='ราคาอาหารทั้งหมด (บาท)',font=('Angsana New',30),fg='#42c2f5')
L.pack(pady=5)
...
###############E2###################
L = Label(GUI,text='มากันกี่คน',font=('Angsana New',30),fg='#42c2f5')
L.pack(pady=5)
...
v_result = StringVar()
result = ttk.Label(GUI,textvariable=v_result,font=('Angsana New',30,'bold'),foreground='#42f54b')
result.pack(pady=10)
